    ...
    'documentations' => [
        ...
        'genuio.v1' => [
            ...
            'routes' => [
                 ...
                 * Route for accessing api documentation interface
                */
                'api' => 'api/genuio/swagger',
                'docs' => 'api/genuio/swagger',
                'oauth2_callback' => 'api/genuio/callback'
            ],
            'paths' => [
                /*
                 * Edit to include full URL in ui for assets
                */
                 ...
                 * File name of the generated json documentation file
                */
                'docs_json' => 'api-genuio-docs.json',

                /*
                 * File name of the generated YAML documentation file
                */
                'docs_yaml' => 'api-genuio-docs.yaml',
                ...
                */
                'annotations' => [
                    base_path('app/Annotations/v1/genuio'),
                ],
            ],
            'scanOptions' => [
                'exclude' => [],
