...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('product_w2_extend_datas', function (Blueprint $table) {
            $table->id();
        ...
        DB::statement('ALTER TABLE product_w2_extend_datas COMMENT "W2 상품 확장 데이터 테이블"');
    }
    ...
    {
        Schema::dropIfExists('product_w2_extend_datas');
    }
};