...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('product_w2_notice_datas', function (Blueprint $table) {
            $table->id();
        ...
        DB::statement('ALTER TABLE product_w2_notice_datas COMMENT "W2 상품 고시정보 데이터 테이블"');
    }
    ...
    {
        Schema::dropIfExists('product_w2_notice_datas');
    }
};