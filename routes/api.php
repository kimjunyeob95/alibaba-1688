...
Route::name('w.')->prefix('w')->group(function () {
    ...
    Route::prefix("order")->name("order.")->group(function(){
        ...
        /** WApp 주문 채널정보 업데이트 */
        Route::patch('/info/channel/update', [WAppOrderController::class, "orderInfoChannelUpdate"])->name("orderInfoChannelUpdate");
        /** WApp 주문 채널정보 삭제 */
        Route::delete('/info/channel/delete', [WAppOrderController::class, "orderInfoChannelDelete"])->name("orderInfoChannelDelete");
    });
    ...
    Route::prefix("wms")->name("wms.")->group(function(){
        ...
        /** 출고 배송정보 업데이트 */
        Route::post("/bonaeraOutDelivery/update", [WAppWmsController::class, "bonaeraOutDeliveryUpdate"])->name("bonaeraOutDeliveryUpdate");
