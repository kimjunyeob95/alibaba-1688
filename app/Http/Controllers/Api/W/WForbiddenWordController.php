...
class WForbiddenWordController extends Controller
{
    ...
    public function getNotice(int $id): JsonResponse
    {
        $result = $this->forbiddenWordService->getNotice($id);
        if( $result["isSuccess"] == true ){
            return helpers_json_response(HttpConstant::OK, $result);
        } else {
            return helpers_json_response(HttpConstant::BAD_REQUEST, [], $result["msg"]);
    ...
    public function createNotice(): JsonResponse
    {
        $validator = Validator::make($this->request->all(), [
            'keyword_type'   => 'required|string',
            'target_keyword' => 'required|string',
        ...
        $result = $this->forbiddenWordService->createNotice($params);
        if( $result["isSuccess"] == true ){
            return helpers_json_response(HttpConstant::OK, $result);
        } else {
            return helpers_json_response(HttpConstant::BAD_REQUEST, [], $result["msg"]);
    ...
    public function updateNotice(): JsonResponse
    {
        $validator = Validator::make($this->request->all(), [
            'id'             => 'required|int',
            'keyword_type'   => 'required|string',
        ...
        $result = $this->forbiddenWordService->updateNotice($params);
        if( $result["isSuccess"] == true ){
            return helpers_json_response(HttpConstant::OK, $result);
        } else {
            return helpers_json_response(HttpConstant::BAD_REQUEST, [], $result["msg"]);
    ...
    public function deleteNotice(): JsonResponse
    {
        $validator = Validator::make($this->request->all(), [
            'ids' => 'required|array',
        ], [
        ...
        $result = $this->forbiddenWordService->deleteNotice($this->request->post("ids"));
        if( $result["isSuccess"] == true ){
            return helpers_json_response(HttpConstant::OK, $result);
        } else {
            return helpers_json_response(HttpConstant::BAD_REQUEST, [], $result["msg"]);
