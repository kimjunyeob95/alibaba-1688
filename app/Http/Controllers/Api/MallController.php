    ...
    public function orderCreate(): JsonResponse
    {
        try {
            $validator = Validator::make($this->request->all(), [
                ...
                'option_param_list.*.price'     => 'required|numeric',
                ...
                'option_param_list.*.price.required'     => OrderErrorMessageConstant::getNotHaveErrorMessage("PRICE"),
                'option_param_list.*.quantity.required'  => OrderErrorMessageConstant::getNotHaveErrorMessage("QUANTITY"),
                'delivery_price.required'                => OrderErrorMessageConstant::getNotHaveErrorMessage("DELIVERY_PRICE"),
