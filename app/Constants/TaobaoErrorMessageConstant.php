...
class TaobaoErrorMessageConstant
{
    ...
    public const ERROR_MESSAGE_TOKEN_OBJ     = "token obj";
    public const ERROR_MESSAGE_ACCESS_TOKEN  = "access_token";
    public const ERROR_MESSAGE_REFRESH_TOKEN = "refresh_token";
