...
class OrderErrorMessageConstant
{
    ...
    public const ERROR_MESSAGE_ORIGIN_CHANNEL_ORDER_ID    = "원본 채널 주문 번호";
    ...
    public const ERROR_MESSAGE_CLEARANCE_TYPE             = "clearance_type";
    ...
    public const ERROR_MESSAGE_LOGISTICSCODE              = "logisticsCode";
    public const ERROR_MESSAGE_SUB_ITEM_IDS               = "subItemIds";
    public const ERROR_MESSAGE_ORDER_CHANNEL_DETAIL_DATAS = "order_channel_detail_datas";
